...
const I18N = {
  ja: {
    ...
    pluginActionError: "プラグイン操作に失敗しました",
    ...
    hintSourceDir: "SOUL.md / SKILL.md / style.yaml がすべて揃ったフォルダを指定してください。不足・不正ファイルがある場合は登録できません。",
    importSourceRequired: "登録元フォルダを入力してください",
    importPersonaIdRequired: "ペルソナIDを入力してください",
    importChecking: "ファイルを確認中...",
    importValidationFailed: "ファイル確認に失敗しました",
    importFileRequired: "必須ファイル",
    importFileInvalid: "ファイル内容が不正です",
    importCompleteReady: "3ファイルを確認しました — 登録可能",
    importNeedsComplete: "3ファイルすべてを正しい形式で用意してください",
    importNeedsValidation: "先にファイル確認を完了してください",
    importInProgress: "インポート中...",
    importPersonaExists: "同じIDのペルソナが既に存在します",
    importFailed: "インポートに失敗しました",
    importDone: "インポート完了",
    importIndexWarning: "索引は再構築できます",
  ...
  en: {
    ...
    pluginActionError: "Plugin action failed",
    ...
    hintSourceDir: "Choose a folder containing valid SOUL.md, SKILL.md, and style.yaml files. Incomplete or invalid personas cannot be imported.",
    importSourceRequired: "Enter the source folder",
    importPersonaIdRequired: "Enter a persona ID",
    importChecking: "Checking files...",
    importValidationFailed: "File validation failed",
    importFileRequired: "required file",
    importFileInvalid: "invalid file content",
    importCompleteReady: "All three files are valid — ready to import",
    importNeedsComplete: "Provide all three files in valid form",
    importNeedsValidation: "Validate the files before importing",
    importInProgress: "Importing...",
    importPersonaExists: "A persona with this ID already exists",
    importFailed: "Import failed",
    importDone: "Import complete",
    importIndexWarning: "index can be rebuilt",
